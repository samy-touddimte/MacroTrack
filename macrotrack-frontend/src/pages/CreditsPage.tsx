      ...
      <section className="w-full max-w-[800px] xl:max-w-none mx-auto py-8 px-5 xl:px-12 text-black">
        ...
        <div className="flex flex-col w-full mt-6">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 xl:gap-12 mb-14">
            ...
            {/* Colonne de Droite : Stack technique */}
            <div className="flex flex-col gap-8">
              {/* Backend */}
              ...
              <div className="w-full flex-grow flex flex-col justify-center">
                <div className="bg-primary rounded-2xl flex flex-col items-center justify-center gap-3 text-center py-8 px-6 text-white w-full">
                  <span className="text-xs text-white/80 uppercase tracking-[0.15em] font-bold">
                    RÉALISÉ PAR
                  </span>
                  <h2 className="font-display text-[2.2rem] text-white m-0 tracking-wide">
                    SAMY TOUDDIMTE
                  </h2>
                  <p className="m-0 text-[0.9rem] text-white/90 max-w-[500px] leading-relaxed">
