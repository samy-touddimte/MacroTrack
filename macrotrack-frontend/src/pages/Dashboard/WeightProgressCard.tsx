    ...
    <div className="card relative">
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="font-display text-3xl sm:text-[2.8rem] m-0 leading-none">
            {data?.latestWeight} <span className="text-sm sm:text-[1.2rem]">KG</span>
          </p>
        </div>
        ...
        <div className="text-right">
          ...
          <p className="font-display text-3xl sm:text-[2.8rem] m-0 leading-none text-primary">
            {data?.activeGoal?.targetWeightKg} <span className="text-sm sm:text-[1.2rem]">KG</span>
          </p>
        </div>
      </div>
